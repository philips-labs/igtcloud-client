...
[**post_study_files_complete**](InstitutesApi.md#post_study_files_complete) | **POST** /hospitals/{hospital_id}/studies/{study_id}/files/$file-upload-completed | 
...
# **post_study_files_complete**
> post_study_files_complete(hospital_id, study_id, payload)
...
with igtcloud.client.services.entities.ApiClient(configuration) as api_client:
    ...
    payload = FileUploadCompleted(
        upload_path="upload_path_example",
    ...
    # example passing only required values which don't have defaults set
    try:
        api_instance.post_study_files_complete(hospital_id, study_id, payload)
    except igtcloud.client.services.entities.ApiException as e:
        print("Exception when calling InstitutesApi->post_study_files_complete: %s\n" % e)
```
