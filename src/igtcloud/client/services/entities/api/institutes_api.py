    ...
    def __init__(self, api_client=None):
        ...
        def __post_study_action(
            ...
            **kwargs
            ...
            >>> thread = api.post_study_action(hospital_id, study_id, async_req=True)
            >>> result = thread.get()
        ...
        self.post_study_action = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'csrf_token',
                ...
                'endpoint_path': '/hospitals/{hospital_id}/studies/{study_id}/$action',
                'operation_id': 'post_study_action',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
