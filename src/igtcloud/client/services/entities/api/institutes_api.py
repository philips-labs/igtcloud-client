...
class InstitutesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __post_study_files_complete(
            self,
            hospital_id,
            study_id,
            payload,
            **kwargs
            ...
            """post_study_files_complete  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.post_study_files_complete(hospital_id, study_id, payload, async_req=True)
            >>> result = thread.get()
        ...
        self.post_study_files_complete = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'csrf_token',
                ...
                'operation_id': 'post_study_files_complete',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__post_study_files_complete
        )
